...
public class SwaggerConfig {
	...
	return new OpenAPI()
			.info(new Info()
					...
					.version("v0.0.1")
				.license(new License()
					.name("Glauber do Prado Dias")
					.url("https://www.linkedin.com/in/glauber-prado-2ba2651b8/"))
				.contact(new Contact()
					.name("Glauber do Prado Dias")
					.url("https://github.com/Glauberdiasprado/Glauberdiasprado")
					.email("glauberdiasprado@gmail.com")))
				.externalDocs(new ExternalDocumentation()
					.description("Github")
					.url("https://github.com/Glauberdiasprado/blogpessoal"));
	}
